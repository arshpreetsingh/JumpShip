...
type Service interface {
	...
	RecommendPricePlansWeekly(smartMeterId string, limit uint64) (domain.PricePlanRecommendation, error)
}
...
//func (p *PricePlans) (smartMeterId string) map[string]float64 {
func (s *service) RecommendPricePlansWeekly(smartMeterId string, limit uint64) (domain.PricePlanRecommendation, error) {
	consumptionsForPricePlans := s.pricePlans.ConsumptionElectricityCostWeekly(smartMeterId)
	if len(consumptionsForPricePlans) == 0 {
...
//func Recomend RecommendPricePlans
