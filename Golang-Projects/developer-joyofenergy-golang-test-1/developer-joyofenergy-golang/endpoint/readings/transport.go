...
func MakeStoreReadingsHandler(
	...
	opts := []kithttp.ServerOption{
		kithttp.ServerBefore(serveroption.ExtractContentTypeIntoContext), // Will Get data from Request.
		kithttp.ServerBefore(serveroption.ExtractAcceptHeaderIntoContext), // Will get Data From Request.
...
func decodeSmartMeterIdFromRequest(_ context.Context, r *http.Request) (interface{}, error) {
	//fmt.Println("this is request from decodeRquest----------->>>>",reflect.TypeOf(strings.Split(r.URL.Path, "/")[3]))
